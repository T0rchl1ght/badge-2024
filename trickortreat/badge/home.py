...
class home:
    def __init__(self, l_disp, dpad):
        ...
        self.disp.setHeader("BSidesPDX 2024")
        ...
        try:
            with open("data/myname.txt", "r") as file:
                ...
                self.disp.setText(
                    ["Trick\tor\tTreat", "Welcome Back,", name], align="c"
                )
        except OSError as e:
            print("Error on home.py line 32")
            print(e)
            name = ""
        ...
        if name == "":
            while True:
                ...
                if self.dpad.x.fell:
                    break
                self.disp.setText(["Trick", "Or", "Treat!"], align="c")
                time.sleep(0.01)
    ...
    def nameEntry(self):
        ...
        while True:
            ...
            if self.dpad.u.fell:
                ...
                player_name[nindex] = chars[cindex]
                self.disp.setTextCursor(
                    instructions + ["".join(player_name)], (nindex, 2)
                )
                ...
                nindex = (
                    nindex + 1
                    if nindex < len(player_name) - 1
                    else len(player_name) - 1
                )
                ...
                self.disp.setText(
                    ["Saving your handle:", str.rstrip("".join(player_name))]
                )
